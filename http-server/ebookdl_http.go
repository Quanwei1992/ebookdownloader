...
func ParseEbhostAndBookIDPost(c *gin.Context) {
	...
	ebhost := c.DefaultQuery("ebhost", "biqufan.com") //设置默认值为 biqufan.com
	...
	switch ebhost {
	case "biqufan.com":
		cmdArgs = append(cmdArgs, "--ebhost=biqufan.com")
	...
	case "899zw.com":
		cmdArgs = append(cmdArgs, "--ebhost=899zw.com")
...
func main() {
	...
	app.Usage = "用于下载 笔趣阁(https://www.biqufan.com/, https://www.biduoxs.com/),999小说网(https://www.899zw.com/) ,顶点小说网(https://www.23us.la) 上面的电子书，并保存为txt格式或者(mobi格式,awz3格式)的电子书"
