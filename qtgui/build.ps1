...
.\goqt_rcc.exe -go main -o ebookdlform_qrc.go ebookdlform.qrc
rsrc -manifest ebookdownloader.manifest -ico ebookdownloader.ico -arch 386 -o rsrc_x32.syso
go build -ldflags "-H windowsgui -X main.Commit=$commit_id -X 'main.BuildTime=$build_time' -X main.Version=$last_tag" -o ebookdl_gui.exe
