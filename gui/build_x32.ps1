...
go build -ldflags "-H windowsgui -w -s -X main.Commit=$commit_id -X 'main.BuildTime=$build_time' -X main.Version=$last_tag -linkmode external -extldflags '-static'" -o ebookdownloader_gui.exe
